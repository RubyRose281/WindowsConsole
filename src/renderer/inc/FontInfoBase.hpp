...
inline constexpr std::wstring_view DEFAULT_TT_FONT_FACENAME{ L"__DefaultTTFont__" };
inline constexpr std::wstring_view DEFAULT_RASTER_FONT_FACENAME{ L"Terminal" };
