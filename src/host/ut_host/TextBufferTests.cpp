                                     ...
                                     const til::CoordType cRight)
{
    ...
    {
        row.ReplaceCharacters(i, i + 1, { &pwszInputString[i], 1 });
    }
...
void TextBufferTests::ResizeTraditionalRotationPreservesHighUnicode()
{
    ...
    _buffer->_storage[pos.Y].ReplaceCharacters(pos.X, pos.X + 2, bButton);
...
void TextBufferTests::ScrollBufferRotationPreservesHighUnicode()
{
    ...
    _buffer->_storage[pos.Y].ReplaceCharacters(pos.X, pos.X + 2, fire);
...
void TextBufferTests::ResizeTraditionalHighUnicodeRowRemoval()
{
    ...
    _buffer->_storage[pos.Y].ReplaceCharacters(pos.X, pos.X + 2, emoji);
...
void TextBufferTests::TestOverwriteChars()
{
    ...
    row.ReplaceCharacters(8, 10, complex1);
    ...
    row.ReplaceCharacters(1, 3, complex1);
    row.ReplaceCharacters(7, 9, complex1);
    VERIFY_ARE_EQUAL(L" \U0001F9D1\U0000200D\U0001F52C    \U0001F9D1\U0000200D\U0001F52C ", row.GetText());

    // Test overwriting wide chars with wide chars.
    row.ReplaceCharacters(1, 3, complex2);
    row.ReplaceCharacters(7, 9, complex2);
    ...
    row.ReplaceCharacters(1, 2, simple);
    row.ReplaceCharacters(8, 9, simple);
    VERIFY_ARE_EQUAL(L" X      X ", row.GetText());

    // Test clearing narrow/wide chars.
    row.ReplaceCharacters(0, 1, simple);
    row.ReplaceCharacters(1, 3, complex2);
    row.ReplaceCharacters(3, 4, simple);
    row.ReplaceCharacters(6, 7, simple);
    row.ReplaceCharacters(7, 9, complex2);
    row.ReplaceCharacters(9, 10, simple);
