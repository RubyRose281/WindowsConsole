...
namespace til // Terminal Implementation Library. Also: "Today I Learned"
{
    namespace details
    {
        // The items in this array are bitmasks.
        // 0b01 indicates characters that are invalid in file *paths*.
        // 0b01 indicates characters that are invalid in file *names*.
        inline constexpr std::array<uint8_t, 128> pathFilter{ {
            ...
            0b00 /* SP  */, 0b00 /* !   */, 0b11 /* "   */, 0b00 /* #   */, 0b00 /* $   */, 0b00 /* %   */, 0b00 /* &   */, 0b00 /* '   */, 0b00 /* (   */, 0b00 /* )   */, 0b11 /* *   */, 0b00 /* +   */, 0b00 /* ,   */, 0b00 /* -   */, 0b00 /* .   */, 0b11 /* /   */,
            0b00 /* 0   */, 0b00 /* 1   */, 0b00 /* 2   */, 0b00 /* 3   */, 0b00 /* 4   */, 0b00 /* 5   */, 0b00 /* 6   */, 0b00 /* 7   */, 0b00 /* 8   */, 0b00 /* 9   */, 0b10 /* :   */, 0b00 /* ;   */, 0b11 /* <   */, 0b00 /* =   */, 0b11 /* >   */, 0b11 /* ?   */,
            0b00 /* @   */, 0b00 /* A   */, 0b00 /* B   */, 0b00 /* C   */, 0b00 /* D   */, 0b00 /* E   */, 0b00 /* F   */, 0b00 /* G   */, 0b00 /* H   */, 0b00 /* I   */, 0b00 /* J   */, 0b00 /* K   */, 0b00 /* L   */, 0b00 /* M   */, 0b00 /* N   */, 0b00 /* O   */,
            0b00 /* P   */, 0b00 /* Q   */, 0b00 /* R   */, 0b00 /* S   */, 0b00 /* T   */, 0b00 /* U   */, 0b00 /* V   */, 0b00 /* W   */, 0b00 /* X   */, 0b00 /* Y   */, 0b00 /* Z   */, 0b00 /* [   */, 0b10 /* \   */, 0b00 /* ]   */, 0b00 /* ^   */, 0b00 /* _   */,
            0b00 /* `   */, 0b00 /* a   */, 0b00 /* b   */, 0b00 /* c   */, 0b00 /* d   */, 0b00 /* e   */, 0b00 /* f   */, 0b00 /* g   */, 0b00 /* h   */, 0b00 /* i   */, 0b00 /* j   */, 0b00 /* k   */, 0b00 /* l   */, 0b00 /* m   */, 0b00 /* n   */, 0b00 /* o   */,
    ...
    _TIL_INLINEPREFIX std::wstring clean_filepath(std::wstring str) noexcept
    {
        std::erase_if(str, [](auto ch) {
            ...
            return (ch < 128) & ((til::details::pathFilter[ch & 127] & 0b01) == 0b01);
        });
        return str;
    }
    ...
    _TIL_INLINEPREFIX std::wstring clean_filename(std::wstring str) noexcept
    {
        std::erase_if(str, [](auto ch) {
            // This lookup is branchless: It always checks the filter, but throws
            // away the result if ch >= 128. This is faster than using `&&` (branchy).
            return (ch < 128) & ((til::details::pathFilter[ch & 127] & 0b10) == 0b10);
        });
        return str;
    }
