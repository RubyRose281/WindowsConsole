...
namespace Microsoft::Console::Types
{
    ...
    public:
        ...
        bool MoveInBounds(const ptrdiff_t move, til::point& pos) const noexcept;
        ...
        bool TrimToViewport(_Inout_ til::rect* const psr) const noexcept;
        void ConvertToOrigin(_Inout_ til::rect* const psr) const noexcept;
